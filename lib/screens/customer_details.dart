...
class _CustomerDetailsScreenState extends State<CustomerDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(backgroundColor: Colors.redAccent, title: Text(query[1]),),
      body: Padding(
           ...
           CircleAvatar(
             ...
             Text(
               ...
               style: TextStyle(
                ...
                }, child: Text('Transfer Money', style: TextStyle(fontSize: 25, color: Colors.white)), fillColor: Colors.green,)
          ],
        ),
      ),
    );
